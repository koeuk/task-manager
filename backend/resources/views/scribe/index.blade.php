    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="admin-dashboard">
                    <a href="#admin-dashboard">Admin · Dashboard</a>
                                ...
                                <a href="#admin-dashboard-GETapi-admin-dashboard">Admin dashboard</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-dashboard-GETapi-admin-reports">
                                <a href="#admin-dashboard-GETapi-admin-reports">Reports (date range)</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="admin-users">
                    <a href="#admin-users">Admin · Users</a>
                                ...
                                <a href="#admin-users-POSTapi-admin-users">Create a user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-users-GETapi-admin-users--id-">
                                <a href="#admin-users-GETapi-admin-users--id-">Get a user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-users-PUTapi-admin-users--id-">
                                <a href="#admin-users-PUTapi-admin-users--id-">Update a user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-users-DELETEapi-admin-users--id-">
                                <a href="#admin-users-DELETEapi-admin-users--id-">Delete a user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-users-PUTapi-admin-users--user--role">
                                <a href="#admin-users-PUTapi-admin-users--user--role">Update a user's role</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="admin-users-POSTapi-admin-users--user--reset-password">
                                <a href="#admin-users-POSTapi-admin-users--user--reset-password">Reset a user's password</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-auth-forgot-password">Request a password reset token</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-auth-reset-password">
                                <a href="#authentication-POSTapi-auth-reset-password">Reset password with a token</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-auth-logout">
                                <a href="#authentication-POSTapi-auth-logout">Log out</a>
                            </li>
                                ...
                                <a href="#authentication-PUTapi-auth-profile">Update profile</a>
                            </li>
                                ...
                                <a href="#authentication-POSTapi-auth-change-password">Change password</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-auth-avatar">
                                <a href="#authentication-POSTapi-auth-avatar">Upload avatar</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="comments">
                    <a href="#comments">Comments</a>
                                    ...
                                    <ul id="tocify-subheader-comments" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="comments-GETapi-comments">
                                <a href="#comments-GETapi-comments">List comments</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="comments-POSTapi-comments">
                                <a href="#comments-POSTapi-comments">Create a comment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="comments-GETapi-comments--id-">
                                <a href="#comments-GETapi-comments--id-">Get a comment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="comments-PUTapi-comments--id-">
                                <a href="#comments-PUTapi-comments--id-">Update a comment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="comments-DELETEapi-comments--id-">
                                <a href="#comments-DELETEapi-comments--id-">Delete a comment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="comments-GETapi-tasks--task--comments">
                                <a href="#comments-GETapi-tasks--task--comments">List a task's comments</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="dashboard">
                    <a href="#dashboard">Dashboard</a>
                                ...
                                <a href="#dashboard-GETapi-dashboard">User dashboard</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="projects">
                    <a href="#projects">Projects</a>
                                ...
                                <a href="#projects-GETapi-projects--id-">Get a project</a>
                            </li>
                    ...
                    <ul id="tocify-header-task-lists" class="tocify-header">
                <li class="tocify-item level-1" data-unique="task-lists">
                    <a href="#task-lists">Task Lists</a>
                </li>
                                    <ul id="tocify-subheader-task-lists" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="task-lists-GETapi-task-lists">
                                <a href="#task-lists-GETapi-task-lists">List task lists</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-lists-POSTapi-task-lists">
                                <a href="#task-lists-POSTapi-task-lists">Create a task list</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-lists-GETapi-task-lists--id-">
                                <a href="#task-lists-GETapi-task-lists--id-">Get a task list</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-lists-PUTapi-task-lists--id-">
                                <a href="#task-lists-PUTapi-task-lists--id-">Update a task list</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-lists-DELETEapi-task-lists--id-">
                                <a href="#task-lists-DELETEapi-task-lists--id-">Delete a task list</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-lists-POSTapi-task-lists-reorder">
                                <a href="#task-lists-POSTapi-task-lists-reorder">Reorder task lists</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="tasks">
                    <a href="#tasks">Tasks</a>
                                ...
                                <a href="#tasks-POSTapi-tasks">Create a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tasks-GETapi-tasks--id-">
                                <a href="#tasks-GETapi-tasks--id-">Get a task</a>
                            </li>
                                ...
                                <a href="#tasks-DELETEapi-tasks--id-">Delete a task</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="tasks-POSTapi-tasks-reorder">
                                <a href="#tasks-POSTapi-tasks-reorder">Reorder tasks</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>REST API for the Task Management System (projects, task lists, tasks, comments, users). Authenticate with a Bearer token obtained from POST /api/auth/login.</p>
<aside>
...
<p>Obtain a token by calling <code>POST /api/auth/login</code> with your email and password, then send it as <code>Authorization: Bearer {token}</code>.</p>

        <h1 id="admin-dashboard">Admin · Dashboard</h1>

    <p>System-wide stats and reports. Requires an authenticated <strong>admin</strong> account.</p>

                                <h2 id="admin-dashboard-GETapi-admin-dashboard">Admin dashboard</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>System-wide totals plus task/priority/role breakdowns and recent activity.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="admin-dashboard-GETapi-admin-reports">Reports (date range)</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Aggregated metrics over a date range plus per-user productivity. Defaults to the last month.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/admin/reports?start_date=2026-06-14&amp;end_date=2026-07-14" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="start_date"                data-endpoint="GETapi-admin-reports"
               value="2026-06-14"
               data-component="query">
    <br>
<p>date Range start (Y-m-d). Example: <code>2026-06-14</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="end_date"                data-endpoint="GETapi-admin-reports"
               value="2026-07-14"
               data-component="query">
    <br>
<p>date Range end (Y-m-d). Example: <code>2026-07-14</code></p>
            </div>
                </form>

                <h1 id="admin-users">Admin · Users</h1>

    <p>User management. Requires an authenticated <strong>admin</strong> account.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/admin/users?role=user&amp;search=jane&amp;per_page=15" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Results per page (default 15). Example: <code>15</code></p>
            </div>
                </form>

                    <h2 id="admin-users-POSTapi-admin-users">Create a user</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: admin, user. Example: <code>user</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Optional phone number. Example: <code>+85512345678</code></p>
        </div>
        </form>

                    <h2 id="admin-users-GETapi-admin-users--id-">Get a user</h2>
...
<p>The user ID. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-users-PUTapi-admin-users--id-">Update a user</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: admin, user. Example: <code>admin</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Phone number. Example: <code>+85512345678</code></p>
        </div>
        </form>

                    <h2 id="admin-users-DELETEapi-admin-users--id-">Delete a user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>The last remaining admin cannot be deleted.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;User deleted successfully&quot;
            ...
            <blockquote>
            <p>Example response (403, Last admin):</p>
        </blockquote>
                <pre>
...
<p>The user ID. Example: <code>2</code></p>
                    ...
                    <h2 id="admin-users-PUTapi-admin-users--user--role">Update a user&#039;s role</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>The last remaining admin cannot be demoted.</p>

<span id="example-requests-PUTapi-admin-users--user--role">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/admin/users/architecto/role" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-PUTapi-admin-users--user--role">
            <blockquote>
            <p>Example response (403, Last admin):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-admin-users--user--role" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-admin-users--user--role"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-admin-users--user--role"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-admin-users--user--role" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-admin-users--user--role">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-admin-users--user--role" data-method="PUT"
      data-path="api/admin/users/{user}/role"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-admin-users--user--role', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-admin-users--user--role"
                    onclick="tryItOut('PUTapi-admin-users--user--role');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-admin-users--user--role"
                    onclick="cancelTryOut('PUTapi-admin-users--user--role');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-admin-users--user--role"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/admin/users/{user}/role</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-admin-users--user--role"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-admin-users--user--role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-admin-users--user--role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="user"                data-endpoint="PUTapi-admin-users--user--role"
               value="architecto"
               data-component="url">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-admin-users--user--role"
               value="2"
               data-component="url">
    <br>
<p>The user ID. Example: <code>2</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="PUTapi-admin-users--user--role"
               value="admin"
               data-component="body">
    <br>
<p>One of: admin, user. Example: <code>admin</code></p>
                    ...
                    <h2 id="admin-users-POSTapi-admin-users--user--reset-password">Reset a user&#039;s password</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Admin sets a new password for the user (no current password needed).</p>

<span id="example-requests-POSTapi-admin-users--user--reset-password">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-admin-users--user--reset-password">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-admin-users--user--reset-password" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-admin-users--user--reset-password"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-admin-users--user--reset-password"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-admin-users--user--reset-password" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-admin-users--user--reset-password">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-admin-users--user--reset-password" data-method="POST"
      data-path="api/admin/users/{user}/reset-password"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-admin-users--user--reset-password', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-admin-users--user--reset-password"
                    onclick="tryItOut('POSTapi-admin-users--user--reset-password');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-admin-users--user--reset-password"
                    onclick="cancelTryOut('POSTapi-admin-users--user--reset-password');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-admin-users--user--reset-password"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/admin/users/{user}/reset-password</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-admin-users--user--reset-password"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-admin-users--user--reset-password"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-admin-users--user--reset-password"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="user"                data-endpoint="POSTapi-admin-users--user--reset-password"
               value="architecto"
               data-component="url">
    <br>
<p>The user. Example: <code>architecto</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-admin-users--user--reset-password"
               value="2"
               data-component="url">
    <br>
<p>The user ID. Example: <code>2</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-admin-users--user--reset-password"
               value="newpass123"
               data-component="body">
    <br>
<p>New password, at least 8 characters. Example: <code>newpass123</code></p>
        </div>
        </form>

                <h1 id="authentication">Authentication</h1>

    <p>Register, log in, and manage the authenticated user's account and password.</p>
...
<p>Creates a <code>user</code>-role account and returns an API token. Admin accounts cannot be created here.</p>
...
<p>Authenticates with email + password and returns an API token.</p>
...
<p>Example: <code>secret123</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-forgot-password">Request a password reset token</h2>

<p>
</p>

<p>Generates a reset token. In production it would be emailed; here it is returned
in the response so the SPA reset flow works without a configured mailer.</p>
...
<p>Example: <code>jane@example.com</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-reset-password">Reset password with a token</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Password has been reset successfully. You can now log in.&quot;
            ...
            <blockquote>
            <p>Example response (422, Invalid/expired token):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The token from the reset request. Example: <code>AbCdEf...</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match password. Example: <code>newpass123</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-auth-logout">Log out</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Revokes the API token used for the current request.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-PUTapi-auth-profile">Update profile</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's full name. Example: <code>Jane D.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Avatar URL. Example: <code>https://example.com/avatar.png</code></p>
        </div>
        </form>
...
<p>The user portal sends <code>current_password</code> (required there); the admin panel may omit it.
When supplied, the current password is verified.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The current password (verified only when provided). Example: <code>oldpass123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Must match password. Example: <code>newpass123</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-avatar">Upload avatar</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Uploads/replaces the authenticated user's avatar image.</p>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "avatar=@/tmp/phpvelsgme0kt1d8ZhZ2p9" </code></pre></div>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-auth-avatar"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Image file (jpeg, jpg, png, gif, webp), max 2 MB. Example: <code>/tmp/phpvelsgme0kt1d8ZhZ2p9</code></p>
        </div>
        </form>

                <h1 id="comments">Comments</h1>

    <p>Comments on tasks. Users may only edit or delete their own comments.</p>

                                <h2 id="comments-GETapi-comments">List comments</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/comments?task_id=1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_id"                data-endpoint="GETapi-comments"
               value="1"
               data-component="query">
    <br>
<p>Filter by task. Example: <code>1</code></p>
            </div>
                </form>

                    <h2 id="comments-POSTapi-comments">Create a comment</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>The authenticated user is recorded as the author.</p>
...
<div class="bash-example">
    ...
    --data "{
    \"task_id\": 1,
    \"comment\": \"Looks great, shipping now!\"
}"
</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_id"                data-endpoint="POSTapi-comments"
               value="1"
               data-component="body">
    <br>
<p>The task to comment on. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Looks great, shipping now!"
               data-component="body">
    <br>
<p>The comment text. Example: <code>Looks great, shipping now!</code></p>
        </div>
        </form>

                    <h2 id="comments-GETapi-comments--id-">Get a comment</h2>
...
<p>The comment ID. Example: <code>1</code></p>
                    ...
                    <h2 id="comments-PUTapi-comments--id-">Update a comment</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Only the author may edit their comment.</p>
...
<span id="example-responses-PUTapi-comments--id-">
            <blockquote>
            <p>Example response (403, Not the author):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The updated text. Example: <code>Edited comment.</code></p>
        </div>
        </form>

                    <h2 id="comments-DELETEapi-comments--id-">Delete a comment</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Only the author may delete their comment.</p>
...
<p>The comment ID. Example: <code>1</code></p>
                    ...
                    <h2 id="comments-GETapi-tasks--task--comments">List a task&#039;s comments</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns all comments for a task (newest first), each with its author.</p>

<span id="example-requests-GETapi-tasks--task--comments">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/tasks/1/comments" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/tasks/1/comments"
);
...
<span id="example-responses-GETapi-tasks--task--comments">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-tasks--task--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-tasks--task--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-tasks--task--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-tasks--task--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-tasks--task--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-tasks--task--comments" data-method="GET"
      data-path="api/tasks/{task}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-tasks--task--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-tasks--task--comments"
                    onclick="tryItOut('GETapi-tasks--task--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tasks--task--comments"
                    onclick="cancelTryOut('GETapi-tasks--task--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-tasks--task--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/tasks/{task}/comments</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-tasks--task--comments"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-tasks--task--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-tasks--task--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task"                data-endpoint="GETapi-tasks--task--comments"
               value="1"
               data-component="url">
    <br>
<p>The task ID. Example: <code>1</code></p>
                ...
                <h1 id="dashboard">Dashboard</h1>
                                ...
                                <h2 id="dashboard-GETapi-dashboard">User dashboard</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Aggregated stats for the authenticated user: project/task counts, recent
projects, upcoming tasks, and recent tasks.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Create and manage projects. Each project holds task lists and tasks.</p>
...
<p>Returns a paginated list of projects (with their task lists and tasks).</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/projects?status=active&amp;search=website&amp;per_page=15&amp;page=1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by status: planning, active, on_hold, completed, archived. Example: <code>active</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>search</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by project name. Example: <code>website</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="GETapi-projects"
               value="1"
               data-component="query">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Full redesign of the marketing site."
               data-component="body">
    <br>
<p>A longer description. Example: <code>Full redesign of the marketing site.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="color"                data-endpoint="POSTapi-projects"
               value="#2196f3"
               data-component="body">
    <br>
<p>A hex color (max 7 chars). Example: <code>#2196f3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="icon"                data-endpoint="POSTapi-projects"
               value="folder"
               data-component="body">
    <br>
<p>An icon name. Example: <code>folder</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>start_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Due date (Y-m-d), on/after start_date. Example: <code>2026-08-01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: planning, active, on_hold, completed, archived. Example: <code>active</code></p>
        </div>
        </form>

                    <h2 id="projects-GETapi-projects--id-">Get a project</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the project with its task lists, tasks, assignees, creators, and comments.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A longer description. Example: <code>Updated scope.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>color</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="color"                data-endpoint="PUTapi-projects--id-"
               value="#10b981"
               data-component="body">
    <br>
<p>A hex color (max 7 chars). Example: <code>#10b981</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>icon</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="icon"                data-endpoint="PUTapi-projects--id-"
               value="rocket"
               data-component="body">
    <br>
<p>An icon name. Example: <code>rocket</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>start_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Due date (Y-m-d), on/after start_date. Example: <code>2026-09-01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: planning, active, on_hold, completed, archived. Example: <code>completed</code></p>
        </div>
        </form>
...
<p>Deletes the project and cascades to its tasks.</p>
...
<p>The project ID. Example: <code>1</code></p>
    ...
    <p>Columns within a project (e.g. "To Do", "In Progress") that group tasks on the board.</p>

                                <h2 id="task-lists-GETapi-task-lists">List task lists</h2>
...
<span id="example-requests-GETapi-task-lists">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/task-lists?project_id=1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-task-lists">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-task-lists" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-task-lists"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-task-lists"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-task-lists" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-task-lists">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-task-lists" data-method="GET"
      data-path="api/task-lists"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-task-lists', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-task-lists"
                    onclick="tryItOut('GETapi-task-lists');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-task-lists"
                    onclick="cancelTryOut('GETapi-task-lists');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-task-lists"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-task-lists"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-task-lists"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-task-lists"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="project_id"                data-endpoint="GETapi-task-lists"
               value="1"
               data-component="query">
    <br>
<p>Filter by project. Example: <code>1</code></p>
            </div>
                </form>

                    <h2 id="task-lists-POSTapi-task-lists">Create a task list</h2>
...
<span id="example-requests-POSTapi-task-lists">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-task-lists">
            <blockquote>
            <p>Example response (201):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-task-lists" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-task-lists"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-task-lists"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-task-lists" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-task-lists">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-task-lists" data-method="POST"
      data-path="api/task-lists"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-task-lists', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-task-lists"
                    onclick="tryItOut('POSTapi-task-lists');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-task-lists"
                    onclick="cancelTryOut('POSTapi-task-lists');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-task-lists"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-task-lists"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-task-lists"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-task-lists"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="project_id"                data-endpoint="POSTapi-task-lists"
               value="1"
               data-component="body">
    <br>
<p>The parent project ID. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-task-lists"
               value="To Do"
               data-component="body">
    <br>
<p>The list name. Example: <code>To Do</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="position"                data-endpoint="POSTapi-task-lists"
               value="0"
               data-component="body">
    <br>
<p>Ordering position (defaults to the end). Example: <code>0</code></p>
        </div>
        </form>

                    <h2 id="task-lists-GETapi-task-lists--id-">Get a task list</h2>
...
<span id="example-requests-GETapi-task-lists--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/task-lists/1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/task-lists/1"
);
...
<span id="example-responses-GETapi-task-lists--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-task-lists--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-task-lists--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-task-lists--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-task-lists--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-task-lists--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-task-lists--id-" data-method="GET"
      data-path="api/task-lists/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-task-lists--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-task-lists--id-"
                    onclick="tryItOut('GETapi-task-lists--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-task-lists--id-"
                    onclick="cancelTryOut('GETapi-task-lists--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-task-lists--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/task-lists/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-task-lists--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-task-lists--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-task-lists--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-task-lists--id-"
               value="1"
               data-component="url">
    <br>
<p>The task list ID. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="task-lists-PUTapi-task-lists--id-">Update a task list</h2>
...
<span id="example-requests-PUTapi-task-lists--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-task-lists--id-">
</span>
<span id="execution-results-PUTapi-task-lists--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-task-lists--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-task-lists--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-task-lists--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-task-lists--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-task-lists--id-" data-method="PUT"
      data-path="api/task-lists/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-task-lists--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-task-lists--id-"
                    onclick="tryItOut('PUTapi-task-lists--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-task-lists--id-"
                    onclick="cancelTryOut('PUTapi-task-lists--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-task-lists--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-task-lists--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-task-lists--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-task-lists--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-task-lists--id-"
               value="1"
               data-component="url">
    <br>
<p>The task list ID. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-task-lists--id-"
               value="In Progress"
               data-component="body">
    <br>
<p>The list name. Example: <code>In Progress</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>position</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="position"                data-endpoint="PUTapi-task-lists--id-"
               value="1"
               data-component="body">
    <br>
<p>Ordering position. Example: <code>1</code></p>
        </div>
        </form>

                    <h2 id="task-lists-DELETEapi-task-lists--id-">Delete a task list</h2>
...
<span id="example-requests-DELETEapi-task-lists--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-task-lists--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-DELETEapi-task-lists--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-task-lists--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-task-lists--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-task-lists--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-task-lists--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-task-lists--id-" data-method="DELETE"
      data-path="api/task-lists/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-task-lists--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-task-lists--id-"
                    onclick="tryItOut('DELETEapi-task-lists--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-task-lists--id-"
                    onclick="cancelTryOut('DELETEapi-task-lists--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-task-lists--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-task-lists--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-task-lists--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-task-lists--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-task-lists--id-"
               value="1"
               data-component="url">
    <br>
<p>The task list ID. Example: <code>1</code></p>
                    ...
                    <h2 id="task-lists-POSTapi-task-lists-reorder">Reorder task lists</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Persists new positions for a set of task lists.</p>

<span id="example-requests-POSTapi-task-lists-reorder">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/task-lists/reorder" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-task-lists-reorder">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-task-lists-reorder" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-task-lists-reorder"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-task-lists-reorder"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-task-lists-reorder" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-task-lists-reorder">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-task-lists-reorder" data-method="POST"
      data-path="api/task-lists/reorder"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-task-lists-reorder', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-task-lists-reorder"
                    onclick="tryItOut('POSTapi-task-lists-reorder');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-task-lists-reorder"
                    onclick="cancelTryOut('POSTapi-task-lists-reorder');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-task-lists-reorder"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/task-lists/reorder</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-task-lists-reorder"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-task-lists-reorder"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-task-lists-reorder"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
        ...
        <details>
            <summary style="padding-bottom: 10px;">
                <b style="line-height: 2;"><code>task_lists</code></b>&nbsp;&nbsp;
<small>object[]</small>&nbsp;
 &nbsp;
 &nbsp;
<br>
<p>The lists with new positions.</p>
            </summary>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_lists.0.id"                data-endpoint="POSTapi-task-lists-reorder"
               value="1"
               data-component="body">
    <br>
<p>The task list ID. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_lists.0.position"                data-endpoint="POSTapi-task-lists-reorder"
               value="0"
               data-component="body">
    <br>
<p>The new position. Example: <code>0</code></p>
                    </div>
                                    </details>
        </div>
        </form>
    ...
    <p>Create and manage tasks within projects and task lists.</p>
...
<p>Returns a paginated list of tasks (with project, list, creator, assignee, comments).</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/tasks?project_id=1&amp;task_list_id=2&amp;status=in_progress&amp;priority=high&amp;assigned_to=3&amp;search=homepage&amp;per_page=15" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="project_id"                data-endpoint="GETapi-tasks"
               value="1"
               data-component="query">
    <br>
<p>Filter by project. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_list_id"                data-endpoint="GETapi-tasks"
               value="2"
               data-component="query">
    <br>
<p>Filter by task list. Example: <code>2</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by status: todo, in_progress, review, completed. Example: <code>in_progress</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by priority: low, medium, high, critical. Example: <code>high</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="assigned_to"                data-endpoint="GETapi-tasks"
               value="3"
               data-component="query">
    <br>
<p>Filter by assignee user ID. Example: <code>3</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>search</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Search title/description. Example: <code>homepage</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<p>Results per page (default 15). Example: <code>15</code></p>
                    ...
                    <h2 id="tasks-POSTapi-tasks">Create a task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>The authenticated user is recorded as the creator.</p>
...
<div class="bash-example">
    ...
    \"description\": \"Hero, nav, and footer.\",
    \"priority\": \"high\",
    \"status\": \"todo\",
    \"assigned_to\": 3,
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_list_id"                data-endpoint="POSTapi-tasks"
               value="2"
               data-component="body">
    <br>
<p>The task list (column) ID. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Design the homepage"
               data-component="body">
    <br>
<p>The task title. Example: <code>Design the homepage</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Hero, nav, and footer."
               data-component="body">
    <br>
<p>A longer description. Example: <code>Hero, nav, and footer.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: low, medium, high, critical. Example: <code>high</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: todo, in_progress, review, completed. Example: <code>todo</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>assigned_to</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>User ID to assign. Example: <code>3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>start_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Start date/time. Example: <code>2026-07-10</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>due_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Due date/time, on/after start_date. Example: <code>2026-07-20</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="estimated_hours"                data-endpoint="POSTapi-tasks"
               value="4.5"
               data-component="body">
    <br>
<p>Estimated hours. Example: <code>4.5</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>position</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="position"                data-endpoint="POSTapi-tasks"
               value="0"
               data-component="body">
    <br>
<p>Ordering position within the list. Example: <code>0</code></p>
        </div>
        </form>

                    <h2 id="tasks-GETapi-tasks--id-">Get a task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the task with project, list, creator, assignee, and comments.</p>
...
<p>Setting status to <code>completed</code> stamps completed_at automatically.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task_list_id"                data-endpoint="PUTapi-tasks--id-"
               value="3"
               data-component="body">
    <br>
<p>Move to another list. Example: <code>3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>title</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Design the homepage v2"
               data-component="body">
    <br>
<p>The task title. Example: <code>Design the homepage v2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A longer description. Example: <code>Updated brief.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: low, medium, high, critical. Example: <code>critical</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: todo, in_progress, review, completed. Example: <code>completed</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>assigned_to</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="assigned_to"                data-endpoint="PUTapi-tasks--id-"
               value="3"
               data-component="body">
    <br>
<p>User ID to assign. Example: <code>3</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Due date/time. Example: <code>2026-07-25</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>estimated_hours</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="estimated_hours"                data-endpoint="PUTapi-tasks--id-"
               value="6"
               data-component="body">
    <br>
<p>Estimated hours. Example: <code>6</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>position</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="position"                data-endpoint="PUTapi-tasks--id-"
               value="1"
               data-component="body">
    <br>
<p>Ordering position. Example: <code>1</code></p>
...
<p>The task ID. Example: <code>1</code></p>
                    ...
                    <h2 id="tasks-POSTapi-tasks-reorder">Reorder tasks</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Persists new positions (and optionally new task lists) for a set of tasks —
used by the board's drag-and-drop.</p>

<span id="example-requests-POSTapi-tasks-reorder">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-tasks-reorder">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-tasks-reorder" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-tasks-reorder"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-tasks-reorder"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-tasks-reorder" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-tasks-reorder">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-tasks-reorder" data-method="POST"
      data-path="api/tasks/reorder"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-tasks-reorder', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-tasks-reorder"
                    onclick="tryItOut('POSTapi-tasks-reorder');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-tasks-reorder"
                    onclick="cancelTryOut('POSTapi-tasks-reorder');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-tasks-reorder"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/tasks/reorder</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-tasks-reorder"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-tasks-reorder"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-tasks-reorder"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>object[]</small>&nbsp;
 ...
 &nbsp;
<br>
<p>The tasks with new positions.</p>
            </summary>
                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="tasks.0.id"                data-endpoint="POSTapi-tasks-reorder"
               value="1"
               data-component="body">
    <br>
<p>The task ID. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="tasks.0.position"                data-endpoint="POSTapi-tasks-reorder"
               value="0"
               data-component="body">
    <br>
<p>The new position. Example: <code>0</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="tasks.0.task_list_id"                data-endpoint="POSTapi-tasks-reorder"
               value="2"
               data-component="body">
    <br>
<p>The list the task now belongs to. Example: <code>2</code></p>
                    </div>
                                    </details>
        </div>
        </form>
