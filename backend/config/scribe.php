...
return [
    ...
    'description' => 'REST API for the Task Management System (projects, task lists, tasks, comments, users). Authenticate with a Bearer token obtained from POST /api/auth/login.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token by calling <code>POST /api/auth/login</code> with your email and password, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
